(function(window, document, $, undefined) {
    ...
    let rehobhallJs = {
        ...
        methods: function(e) {
            rehobhallJs.salActive();
            rehobhallJs.magnigyPopup();
            rehobhallJs.slickSlider();
            rehobhallJs.headerSticky();
            rehobhallJs.counterUp();
            rehobhallJs.productHoverTilt();
            rehobhallJs.masonryActivation();
            rehobhallJs.lightboxActivation();
            rehobhallJs.boxHover();
            rehobhallJs.boxHoverSlider();
            rehobhallJs.pricingPlan();
            rehobhallJs.wowActivation();
            rehobhallJs.qtyBtn();
            rehobhallJs.accordionBtnTwo();
            rehobhallJs.bannerAnimation();
            rehobhallJs.popupMobileMenu();
            rehobhallJs.searchPopup();
            rehobhallJs.bgMarque();
            rehobhallJs.filterClickButton();
            rehobhallJs.contactForm();
        },
        ...
        slickSlider: function() {
            ...
            $('.rehobhall-home-five-testimonial-activation').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 500,
            ...
            $('.rehobhall-course-details-related-course-carousel').slick({
                dots: false,
                infinite: true,
                arrows: false,
                speed: 1000,
            ...
            $('.rehobhall-course-carousel-page-with-dots').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 1000,
            ...
            $('.rehobhall-event-one-carousel-wrapper').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 1000,
        ...
        productHoverTilt: function() {
            if ($.isFunction($.fn.tilt)) {
                $('.rehobhall-single-product-thumb-wrapper').tilt({
                    maxTilt: 30,
                    perspective: 1000,
        ...
        boxHover: function() {
            jQuery('.edu-instructor-3-visible, .rehobhall-hover-item-visible').on('mouseenter', function() {
                let selector = jQuery(this).parent().parent();
                selector.find('.edu-instructor-3-visible, .rehobhall-hover-item-visible').removeClass('rehobhall-hover-active');
                jQuery(this).addClass('rehobhall-hover-active');
            });
        },
        ...
        boxHoverSlider: function() {
            jQuery('.edu-instructor-3-slider-visible').on('mouseenter', function() {
                ...
                selector.find('.edu-instructor-3-slider-visible').removeClass('rehobhall-hover-active');
                jQuery(this).addClass('rehobhall-hover-active');
            });
        },
        ...
        searchPopup: function() {
            ...
            $('.edu-search-popup .rehobhall-search-popup-field').on('click', function(e) {
                e.stopPropagation();
            })
        },
